...
{
    using Hypertable;
    using Hypertable.Persistence.Test.TestIdAttributeTypes;

    using Microsoft.VisualStudio.TestTools.UnitTesting;

    namespace TestIdAttributeTypes
    {
        using System;
        ...
        internal class EntityA
        {
            ...
            public EntityA()
            {
                this.Name = this.Transient = this.Ignore = Guid.NewGuid().ToString();
            }
    ...
    /// </summary>
    [TestClass]
    public class TestIdAttribute : TestBase
    {
        #region Public Methods and Operators
