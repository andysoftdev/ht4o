...
namespace Hypertable.Persistence
{
    ...
    internal sealed class EntityReference
    {
        ...
        /// The column binding.
        /// </value>
        internal IColumnBinding ColumnBinding
        {
            get
            {
        ...
        /// The column family set.
        /// </value>
        internal ISet<string> ColumnFamilySet
        {
            get
            {
                return this.columnFamilySet;
            }
        }
        ...
        /// The column set.
        /// </value>
        internal ISet<string> ColumnSet
        {
            get
            {
        ...
        /// The key binding.
        /// </value>
        internal IKeyBinding KeyBinding
        {
            get
            {
        ...
        internal string Namespace
        {
            get
            {
                return this.tableBinding.Namespace;
            }
        }
        ...
        /// The table binding.
        /// </value>
        internal ITableBinding TableBinding
        {
            get
            {
        ...
        internal string TableName
        {
            get
            {
                return this.tableBinding.TableName;
            }
        }
        ...
        internal void EstablishColumnSets(Func<IEnumerable<string>> establishColumns)
        {
            ...
            {
                throw new ArgumentNullException("establishColumns");
            }
        ...
        internal Key GetKeyFromObject(object entityOrKey, bool verifyColumnFamily)
        {
            ...
            if (this.EntityType.IsInstanceOfType(entityOrKey))
            {
                ...
                if (entityKey == null)
                {
                    throw new PersistenceException(string.Format(CultureInfo.InvariantCulture, @"Query key from entity {0} failed", entityOrKey));
                }
            }
            else
            {
                ...
                if (entityKey == null)
                {
                    throw new PersistenceException(string.Format(CultureInfo.InvariantCulture, @"Query key from value {0} failed", entityOrKey));
                }
            }
        ...
        private Key VerifyKey(Key key, bool verifyColumnFamily)
        {
            ...
            {
                throw new ArgumentException(@"Row key has not been specified", "key");
            }
            ...
            if (verifyColumnFamily && string.IsNullOrEmpty(key.ColumnFamily))
            {
                ...
                {
                    throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, @"Undefined column binding for type {0}", this.entityType));
                }

                throw new ArgumentException(@"Missing column family)", "key");
            }
