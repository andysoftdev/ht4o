namespace Hypertable.Persistence.Collections.Concurrent
{
    ...
    /// </remarks>
    internal class FastConcurrentDictionary<TKey, TValue, TComparer> : IDictionary<TKey, TValue>
    ...
    internal class
        FastConcurrentDictionary<TKey, TValue> : FastConcurrentDictionary<TKey, TValue,
            Collections.EqualityComparer<TKey>>
    {
        #region Constructors and Destructors
